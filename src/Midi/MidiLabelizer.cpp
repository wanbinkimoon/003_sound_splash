...
void ofMidiModule::labelizer(){
  ...
  knobsONELabel[12] = "Knob - 13";
  knobsONELabel[13] = "Knob - 14";
  ...
  padsONELabel[5] = "Pad - 6";
  padsONELabel[6] = "Pad - 7";
  padsONELabel[7] = "Pad - 8";
  ...
  knobsTWOLabel[12] = "Knob - 13";
  knobsTWOLabel[13] = "Knob - 14";
